...
public class LayoutBox : ILayoutElement
{
	...
	public static LayoutBoxBuilder New()
	{
		return new LayoutBoxBuilder();
	}

	public static LayoutBoxBuilder New(Action<LayoutBoxBuilder> construct)
	{
		var builder = new LayoutBoxBuilder();
