...
namespace Fydar.Samples.Formatting.JsonFormatting.Internal.Parsing
{
	public static class JsonParser
	{
		...
		public static IEnumerable<JsonNode> Parse(string source)
		{
				...
				switch (tokenType)
				{
					case JsonLexerTokenType.String:
					{
						...
						yield return new JsonNode(
							peek.Type == JsonNodeLocation.LocationType.Object
							? JsonNodeType.PropertyName
							: JsonNodeType.StringLiteral, token.StartIndex, token.Length);
