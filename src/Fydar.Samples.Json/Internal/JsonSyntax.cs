using Fydar.Samples.Formatting.JsonFormatting.Internal.Parsing;
using System;

namespace Fydar.Samples.Formatting.JsonFormatting.Internal
{
	internal class JsonSyntax
	{
		...
		public static Sample ToCodeBlocks(string name, string script)
		{
			var output = new SampleBuilder(name, 0);
		...
		private static void WriteWithEscapedHighlighting(SampleBuilder output, ReadOnlySpan<char> content, string style, string escapedString)
		{
